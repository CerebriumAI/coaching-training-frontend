...
const Splash: React.FC<SplashProps> = ({ handleReady }) => {
  ...
  return (
    <main className="w-full min-h-screen flex items-start justify-center bg-primary-200 p-4 bg-[length:auto_50%] lg:bg-auto bg-colorWash bg-no-repeat bg-right-top overflow-y-auto">
      <div className="flex flex-col gap-8 lg:gap-12 items-center max-w-full lg:max-w-3xl py-16 mt-8">
